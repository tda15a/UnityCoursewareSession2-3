...
public class AsteraX : MonoBehaviour
{
    ...
    public AsteroidsScriptableObject asteroidsSO_PC;
    public AsteroidsScriptableObject asteroidsSO_Mobile;
    //this is the reference to the SO we choose based on what our current platform is.
