...
public class PlayerShip : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float aX = CrossPlatformInputManager.GetAxis("Horizontal")+Input.acceleration.x;
        float aY = CrossPlatformInputManager.GetAxis("Vertical")+Input.acceleration.y;
    ...
    void Fire()
    {
        ...
        Vector3 mPos = CrossPlatformInputManager.mousePosition;
